...
<p>Effective date: June 02, 2019</p>


<p>Black Books ("us", "we", or "our") operates the http://phplaravel-281171-871102.cloudwaysapps.com/ website (the
    "Service").</p>

<p>This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our
    Service and the choices you have associated with that data. Our Privacy Policy for Black Books is created with the
...
<p>We use your data to provide and improve the Service. By using the Service, you agree to the collection and use of
    ...
    http://phplaravel-281171-871102.cloudwaysapps.com/</p>
...
<p>Black Books uses the collected data for various purposes:</p>
<ul>
...
<p>If you are located outside Czech Republic and choose to provide information to us, please note that we transfer the
    data, including Personal Data, to Czech Republic and process it there.</p>
<p>Your consent to this Privacy Policy followed by your submission of such information represents your agreement to that
    transfer.</p>
<p>Black Books will take all steps reasonably necessary to ensure that your data is treated securely and in accordance
...
<p>Black Books may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
<ul>
    <li>To comply with a legal obligation</li>
    <li>To protect and defend the rights or property of Black Books</li>
...
<ul>
    <li>By email: tomasmenger@usa.com</li>

</ul>
<?php /**PATH D:\xampp\htdocs\blog\resources\views/privacy.blade.php ENDPATH**/ ?>