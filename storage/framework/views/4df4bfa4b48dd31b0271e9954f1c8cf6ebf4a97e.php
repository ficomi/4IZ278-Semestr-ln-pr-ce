                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="postal_code" type="text" name="postal_code" class="form-control<?php echo e($errors->has('postal_code') ? ' is-invalid' : ''); ?>"
                        ...
                        <div class="form-group row">
                            <label for="phone_number" class="col-md-4 col-form-label text-md-right font-weight-bold"><?php echo e(__('Telefoní číslo')); ?></label>

                            <div class="col-md-6">
                                <input id="phone_number" type="number" name="phone_number" class="form-control<?php echo e($errors->has('phone_number') ? ' is-invalid' : ''); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\blog\resources\views/orderCreate.blade.php ENDPATH**/ ?>