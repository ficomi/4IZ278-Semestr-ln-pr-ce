        ...
        <div class="card my-card m-3 xdcard">
            <div class="card-body">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4">
                            <span class="card-text"><?php echo e($book->price); ?></span>
                        </div>
                        <div class="col-md-8">
                            <a href="<?php echo e(route('singlebook', $book->id )); ?>" class="btn btn-sm btn-primary float-right"><?php echo e(__('Detail knihy')); ?></a>
                        </div>
                    </div>
                </div>
            </div>
