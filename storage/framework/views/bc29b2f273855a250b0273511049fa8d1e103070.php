...
<div class="container">
    ...
    <form method="POST" enctype="multipart/form-data" action="<?php echo e(route('adminbookedit', $book->id)); ?>" aria-label="<?php echo e(__('Úprava knihy')); ?>">
        ...
        <div class="row">
            <div class="col-md-12">
                <img class="img-fluid p-2 rounded mx-auto d-block" src="<?php echo e(Storage::url($book->image)); ?>">
            </div>
        </div>
        <hr />
        <div class="row">
            <div class="col-md-12">
                <div class="form-group row justify-content-center">
                    <label for="image" class="col-md-4 col-form-label text-md-right font-weight-bold"><?php echo e(__('Nová fotka knihy')); ?></label>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\blog\resources\views/bookEdit.blade.php ENDPATH**/ ?>