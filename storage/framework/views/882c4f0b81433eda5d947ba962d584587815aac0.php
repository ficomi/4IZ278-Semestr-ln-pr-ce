...
<div class="container">
    <h3><?php echo e(__('Přidání nové knihy')); ?></h3>
    <hr />
    <form method="POST" enctype="multipart/form-data" action="<?php echo e(route('adminbookstore')); ?>" aria-label="<?php echo e(__('Vytvořit knihu')); ?>">
        <?php echo csrf_field(); ?>
        <div class="row">
            <div class="col-md-12">
                <div class="form-group row justify-content-center">
                    <label for="image" class="col-md-4 col-form-label text-md-right font-weight-bold"><?php echo e(__('Fotka knihy - ')); ?></label>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right font-weight-bold"><?php echo e(__('Název knihy')); ?></label>

                            <div class="col-md-6">
                                <input id="name" type="text" name="name" class="form-control<?php echo e($errors->has('name') ? ' is-invalid' : ''); ?>" value="<?php echo e(old('name')); ?>"
                                    autofocus required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="genre" type="text" name="genre" class="form-control<?php echo e($errors->has('genre') ? ' is-invalid' : ''); ?>" value="<?php echo e(old('genre')); ?>">
                        ...
                        <div class="form-group row">
                            <label for="price" class="col-md-4 col-form-label text-md-right font-weight-bold"><?php echo e(__('Cena')); ?></label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="published_in" type="number" step="1" min="0" name="published_in" class="form-control<?php echo e($errors->has('published_in') ? ' is-invalid' : ''); ?>"
                                    value="<?php echo e(old('published_in')); ?>">
                        ...
                        <div class="form-group row">
                            <div class="col-md-10">
                                <button type="submit" class="btn btn-success float-right"><?php echo e(__('Přidat knihu')); ?></button>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\blog\resources\views/bookCreate.blade.php ENDPATH**/ ?>