...
<div class="container">
    ...
    <p>Effective date: June 02, 2020</p>


    <p>Privacy Policy ("us", "we", or "our") operates the https://ficomiloslav.xyz/ website (the
        "Service").</p>

    <p>This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our
        Service and the choices you have associated with that data. Our Privacy Policy for Funny Bookstore is created with the
    ...
    <p>Funny Bookstore uses the collected data for various purposes:</p>
    <ul>
    ...
    <p>Your consent to this Privacy Policy followed by your submission of such information represents your agreement to that
        transfer.</p>
    <p>Funny Bookstore will take all steps reasonably necessary to ensure that your data is treated securely and in accordance
    ...
    <p>Funny Bookstore may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
    <ul>
        <li>To comply with a legal obligation</li>
        <li>To protect and defend the rights or property Funny Bookstore</li>
    ...
    <ul>
        <li>By email: ficomiloslav@seznam.cz</li>
