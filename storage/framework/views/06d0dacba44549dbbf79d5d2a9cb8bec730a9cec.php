...
<div class="container">
    ...
    <div class="row justify-content-center">
        ...
        <?php else: ?>
        <form method="POST" action="<?php echo e(route('ordercreate')); ?>">
            <?php echo csrf_field(); ?>
            <table class="table table-striped table-bordered table-hover text-center table-radius">
                <thead class="thead-info">
                    <tr>
                        ...
                        <th><?php echo e(__('Cena jednoho kusu')); ?></th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center align-baseline xdtd"> <input type="number" class="form-control" name="count<?php echo e($book->id); ?>" value="<?php echo e($book->pivot->count); ?>" /> </td>
                        <td class="text-center align-baseline"><a class="btn btn-danger" href="<?php echo e(route('shoppingcartdelete', $book->id)); ?>" onclick="event.preventDefault();
            ...
            <div class="col-md-6 float-right">
                <button type="submit" class="btn btn-lg btn-success float-right"><?php echo e(__('Pokračovat k objednávce')); ?></button>
            </div>
        </form>
        <?php endif; ?>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\blog\resources\views/shoppingcart.blade.php ENDPATH**/ ?>