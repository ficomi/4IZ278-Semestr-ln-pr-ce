        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group row justify-content-center">
                    <label for="image" class="col-md-4 col-form-label text-md-right font-weight-bold"><?php echo e(__('Titulní obrázek')); ?></label>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\blog\resources\views/bookCreate.blade.php ENDPATH**/ ?>