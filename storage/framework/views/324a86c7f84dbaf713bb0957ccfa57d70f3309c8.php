...
<div class="container">
    <div class="row">
        <div class="col-md-6">
            <img class="img-fluid p-2" width="360px" height="auto" src="<?php echo e(Storage::url($book->image)); ?>">
        </div>
        <div class="col-md-6">
            <div class="row">
                <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h3 class="text-center"><?php echo e($book->price . __(' Kč')); ?></h3>

                   
                </div>
                <div class="col-md-12">
                <a <?php if(auth()->guard()->check()): ?> href="<?php echo e(route('bookaddwishlist', $book->id)); ?>" <?php endif; ?> <?php if(auth()->guard()->guest()): ?> href=""
                            onclick="event.preventDefault(); alert('Nejdříve se, prosím, přihlašte.');" <?php endif; ?>
                            ><?php echo e(__('Přidat do Wishlistu')); ?></a>
                </div>
            </div>
        </div>
    </div>
    <hr>
    <h3><?php echo e(__('Podobné tituly')); ?></h3>
    <div class="row justify-content-left">    
        ...
        <div class="card my-card m-3">
            ...
            <div class="card-body">
                <p class="card-text"><?php echo e($similairbook->price . __(' Kč')); ?></p>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\FunnyBookstore\resources\views/book.blade.php ENDPATH**/ ?>