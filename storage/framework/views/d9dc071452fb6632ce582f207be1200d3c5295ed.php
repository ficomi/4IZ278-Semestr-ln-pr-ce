                    ...
                    <tr>
                        ...
                        <td class="text-center align-baseline">
                            <form method="POST" action="<?php echo e(route('adminbookdelete', $book->id)); ?>">
                                ...
                                <button class="btn btn-sm btn-danger" onclick="confirm('Opravdu smazat?');"><?php echo e(__('Odstranit knihu')); ?></button>
                            </form>
                        </td>
                    </tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\blog\resources\views/adminBooks.blade.php ENDPATH**/ ?>