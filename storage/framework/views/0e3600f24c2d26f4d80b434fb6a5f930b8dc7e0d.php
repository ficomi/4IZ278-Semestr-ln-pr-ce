    ...
    <div class="row">
        <div class="col-md-12">
            <ul>
                ...
                <li>
                    <h4><?php echo e(__('Stav ojednávky: ')); ?><?php echo e($order->status); ?></h4>
                </li>
...
<hr />
<div class="col-md-4">
    <a class="btn btn-danger btn-sm float-right" <?php if(auth()->user()->isAdmin()): ?> href="<?php echo e(route('adminorders')); ?>" <?php else: ?>
        href="<?php echo e(route('orders')); ?>"
        <?php endif; ?>><?php echo e(__('Zpět na seznam objednávek')); ?></a>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\blog\resources\views/orderDetail.blade.php ENDPATH**/ ?>